...
export default function index() {
    ...
    return (
        <>
            <CustomHead title="How AlgoScraper Works"/>
            <main className="w-screen min-h-screen">
                <div className="flex justify-between items-center w-[95vw] mx-auto mt-4" >
                    <div className="flex justify-start items-center gap-2 ">
                        <Link href={"/"}>
                        <h1 className="monu text-sm md:text-2xl tracking-wider caret-transparent cursor-pointer"><span className='text-blue-600'>Algo</span>Scraper</h1>
                        </Link>
                ...
                <div className="w-[90vw] h-full bg-[#eaeaeaec] dark:bg-[#232327]  mx-auto rounded-md my-10 p-4 flex justify-start items-center flex-col gap-5 comfort">
                    <div>
                        ...
                        <p>
                        To deliver a comprehensive search experience for algorithmic problems, we recognize the importance of having a diverse and extensive dataset. To achieve this, we utilize web scraping techniques to gather relevant data from various online sources. By collecting and organizing this data, we ensure that AlgoScraper has a rich repository of algorithms to search through and process with machine learning algorithms.
                        </p>
                    </div>
                    <div>
                        <h1 className="monu text-xl text-blue-600">Implementing TF-IDF</h1>
                        <p>
                        After obtaining data through web scraping, we harness the power of machine learning to enhance AlgoScraper's search capabilities. One key algorithm we use is TF-IDF (Term Frequency-Inverse Document Frequency). TF-IDF helps us determine the significance of each keyword within the entire dataset. By applying TF-IDF to the scraped data, we ensure that AlgoScraper provides accurate and relevant results based on the user's search query.
                        </p>
                    </div>
                    <div>
                        <h1 className="monu text-xl text-blue-600">Setting up Backend</h1>
                        <p>
                        Behind the scenes, AlgoScraper depends on a robust backend infrastructure to process user requests and deliver predicted results. We have developed a RESTful API that efficiently manages incoming queries and interfaces with the machine learning algorithms running in the background. This setup ensures seamless interaction between the frontend and backend components of AlgoScraper, enabling fast and reliable performance.
                        </p>
                    </div>
                    <div>
