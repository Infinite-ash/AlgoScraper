...
export default function index() {
    ...
    return (
        <>
            <CustomHead title="About AlgoScraper"/>
            <main className="w-screen min-h-screen">
                <div className="flex justify-between items-center w-[95vw] mx-auto mt-4" >
                    <div className="flex justify-start items-center gap-2 ">
                        <Link href={"/"}>
                            <h1 className="monu text-sm md:text-2xl tracking-wider caret-transparent cursor-pointer"><span className='text-blue-600'>Algo</span>Scraper</h1></Link>
                ...
                <div className="w-[90vw] h-full bg-[#eaeaeaec] dark:bg-[#232327]  mx-auto rounded-md my-10 p-4 flex justify-start items-center flex-col gap-5 comfort">
                    <p>
                        Welcome to <span className="monu">AlgoScraper</span>, the premier algorithmic problem search engine designed for the prestigious Algozenith Web Dev Hackathon. AlgoScraper is your ultimate destination for discovering the perfect Data Structures and Algorithms (DSA) or Competitive Programming (CP) challenges.
                    </p>
                    <p>
                    Our mission is to enhance your coding journey, making it both efficient and enjoyable. Whether you're a novice aiming to hone your skills or an experienced programmer seeking a new challenge, AlgoScraper is here to assist you.
                    </p>
                    <p>

                        With a simple keyword search, you can easily explore a vast collection of problems curated by industry experts. AlgoScraper leverages powerful algorithms and intelligent indexing techniques to deliver accurate and relevant results for your specific needs. We understand that time is precious, and our aim is to save you valuable hours spent on searching for the right problem.
                    </p>
                    <p>

                        AlgoScraper owes its success to the invaluable guidance of mentors  <span className="text-blue-600 cursor-pointer"><a href="https://www.linkedin.com/in/acraider/" target="_blank">Vivek Gupta</a></span> and <span href="https://www.linkedin.com/in/prabaljainn/" target="_blank" className="text-blue-600 cursor-pointer"><a>Prabal Jain</a></span> . With their extensive knowledge and expertise, they have shaped AlgoScraper into an indispensable tool for every aspiring coder.
                    </p>
                    <p>

                        Join the AlgoScraper community today and unlock a world of challenging and engaging algorithmic problems. Whether you're preparing for coding interviews, participating in programming competitions, or simply honing your problem-solving skills, AlgoScraper has got you covered.
                    </p>
                    <p>
                        Embrace the power of algorithms and embark on an exciting problem-solving adventure with <span className="monu">AlgoScraper!</span>
                    </p>
                    <p>
                        Developer  <span className="text-blue-600 cursor-pointer"><a href="https://www.linkedin.com/in/ashwini-raj-415b8a24b/" target="_blank">Ashwini Raj</a></span>
                    </p>
                </div>
